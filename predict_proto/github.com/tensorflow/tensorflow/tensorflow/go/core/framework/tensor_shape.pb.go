...
func (*TensorShapeProto) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0} }
...
func (*TensorShapeProto_Dim) Descriptor() ([]byte, []int) { return fileDescriptor4, []int{0, 0} }
...
func init() { proto.RegisterFile("tensor_shape.proto", fileDescriptor4) }
